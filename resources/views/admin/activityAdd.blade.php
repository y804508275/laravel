...
@section('body')
    ...
    <div class="container">
        <div class="row">
            <div>
                <form action="/admin/activity/add" method="post" id="myForm" enctype="multipart/form-data">
                    ...
                    <select class="form-control" name="city">
                        @foreach($result['city'] as $res)
                            <option>{{ $res->cityName }}</option>
                        @endforeach
                    </select>
                    <div class="form-group">
                        <label for="exampleInputEmail1">地点</label>
                        <input type="text" class="form-control" id="exampleInputEmail1" name="place" placeholder="地点">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div style="width: 100%;">
                            <script id="tipsEditor" type="text/plain" style="width:100%;height:300px;"></script>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="exampleInputEmail1" name="name" placeholder="发起人姓名">
                    </div>
                    <div class="form-group">
                        <label for="exampleInputEmail1">发起人介绍</label>
                        <input type="text" class="form-control" id="exampleInputEmail1" name="personInfo" placeholder="发起人介绍">
                    </div>
                    <div class="form-group">
                        <label for="exampleInputEmail1">活动日期</label>
                        <input type="text" class="form-control" id="exampleInputEmail1" name="date" placeholder="活动日期">
                    </div>
                    <div class="form-group">
                        <label for="exampleInputEmail1">最多参与人数</label>
                        <input type="text" class="form-control" id="exampleInputEmail1" name="maxNum" placeholder="最多参与人数">
                    </div>
                    <div class="form-group">
                        <label for="exampleInputEmail1">最少参与人数</label>
                        <input type="text" class="form-control" id="exampleInputEmail1" name="minNum" placeholder="最少参与人数">
                    </div>
                    <div class="form-group">
                        <label for="exampleInputEmail1">活动时长</label>
                        <input type="text" class="form-control" id="exampleInputEmail1" name="time" placeholder="活动时长">
                    </div>
