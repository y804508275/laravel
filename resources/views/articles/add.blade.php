...
@section('body')
    ...
    <div class="container">
        <div class="row">
            <div>
                <form action="/admin/article/add" method="post" id="myForm" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <div style="width: 100%;">
                            <script id="textEditor" type="text/plain" style="width:100%;height:500px;"></script>
                        </div>
