        ...
        <div class="city-list" id="city-list">
            ...
            <div class="city-list-middle">
                <div class="city-list-row">
                    ...
                    <div class="city-name-btn" onclick="location.href='{{ url('/city',$res->cityName) }}'">
                        <div>{{ $res->cityName }}</div>
                    </div>
                    @endforeach
    ...
    <!--                <a class="headBtn">出发</a>-->
        ...
        <div class="block">
            <div class="pc-textrow text-left">
                ...
                <div class="cityRow" style="background-image: url(images/wuhan.jpg);" onclick="location.href='{{ url('/city','武汉') }}'";>
                    <div class="city-des">
                ...
                <div class="inline-box city2">
                    <div class="cityRow" style="background-image: url(images/beijing.jpg);" onclick="location.href='{{ url('/city','北京') }}'">
                        <div class="city-des">
                            <p class="city-name">北京</p>
                            <p class="city-note"></p>
                        </div>
                    </div>
                    <div class="cityRow city3" style="background-image: url(images/guangzhou.jpg);" onclick="location.href='{{ url('/city','广州') }}'">
                        <div class="city-des">
...
{{--                }--}}
                ...
                @endforeach
                <div style="clear:both;"></div>     
                <div class="button" onclick="location.href='/list'">
                    查看更多
                </div>
                <div style="clear: both;"></div>
            </div>
